...
<html>
        ...
        <script type="text/javascript">
            ...
            function checkRePassword(){
                ...
                if(uRePassword!=uPassword){
                    document.getElementById("errorRePassword").innerHTML = "Mật khẩu không khớp";
    ...
    <body>
        ...
        <div class="container" style="background-color: rgba(66, 52, 52, 0.897);
                                        ...
                                        margin:100px 0px 200px 200px;-webkit-box-shadow: 3px -4px 30px 0px rgba(168,114,146,1);
                                        -moz-box-shadow: 3px -4px 30px 0px rgba(168,114,146,1);
                                        box-shadow: 3px -4px 30px 0px rgba(168,114,146,1); height:800px">
            <button type="button" class="btn btn-outline-warning" style="width:350px;margin:100px 0px 50px 380px;height:60px">
                Đăng kí thành viên
            </button>
            <form action="Functions/Function_TV.php" method="POST">
                <div class="Col-left">
                    ...
                    <div class="left">Nhập lại password:</div></br>
                    <div class="right"><input name="repassword" id="rePassword" oninput="checkRePassword();" type="password" placeholder="Nhập lại password" required></div>
                ...
                <input class="btn btn-outline-success" type="submit" name="btn_Add_User" value="Tạo tài khoản"  onclick="checkForm();
                        "style="width:120px; height:50px;font-size:12px;margin:30px 0px 0px 500px">
            </form>
        </div>
    </body>
</html>