        ...
        <nav class="navbar navbar-expand-md navbar-light bg-light sticky-top">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                    <p style="color: DeepPink; margin-top:20px">hello <a class="navbar-brand" href="#">Tên</a>
                </div>
                </br></br></br></br></br>
            </div>
            <div class="btn-group" style="margin-left:10px; padding-right: 5px;">
                <button type="button" class="btn btn-danger dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="width:80px; height:40px">
                    Users
                </button>
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="#">Tài khoản thành viên</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="#">Tài khoản admin</a>
                </div>
            </div>
            <div class="btn-group" style="padding-right: 5px;">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="#">Thêm rạp</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="#">Danh sách tất cả các rạp</a>
                </div>
            </div>
            <div class="btn-group" style="padding-right: 5px;">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="#">Thêm Phim</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="#">Danh sách phim</a>
                </div>
            </div>
            <div class="btn-group" style="padding-right: 5px;">
            ...
            <button type="button" class="btn btn-dark" style="width:330px">Đăng xuất</button>
        </nav>
        </br>
    </body>
</html>