        ...
        <script type="text/javascript">
            ...
            function checkHotline(){
                ...
                if(!RegexpHotline.test(Hotline) || Hotline.length != 10){
                    document.getElementById("errorHotline").innerHTML = "Số hotline không hợp lệ";
                    validHotline = false;
                }else{
            ...
            <div class="Col-right">
                <form action="Edit_Rap.php?action=capnhat" method="POST">
                    <div class="Form">
                        ...
                        <div class="right">
                            <input name="Ten_Rap" id="Ten_Rap" type="text" placeholder="Nhập tên rạp" value="<?php echo $row["Ten_Rap"];?>"required>
                        </div>
                        <span class="error" id="errorUserName"></span>
                        <div class="left">Địa chỉ:</div>
                        <div class="right">
                            <input name="Dia_Chi" id="Dia_Chi" type="text" placeholder="Nhập địa chỉ" value="<?php echo $row["Dia_Chi"];?>" required>
                        </div>
                        <span class="error" id="errorPassword"></span>
                        <div class="left">Hotline:</div>
                        <div class="right">
                            <input name="Hotline" id="Hotline" type="text" oninput="checkHotline();" placeholder="Nhập số Hotline" value=" <?php echo $row["Dia_Chi"];?>" required>
                        </div>
