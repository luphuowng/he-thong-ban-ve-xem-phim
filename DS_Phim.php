...
<html>
    <head>
        <title>Admin - Danh sách phim</title>
    </head>
    ...
    <body>
        ...
        <div class="container" style="background-color: rgba(66, 52, 52, 0.897);
            ...
            <button type="button" class="btn btn-outline-warning" style="width:350px;margin:80px 0px 100px 380px; height:60px">Danh sách phim đang chiếu</button>
        <table class="table table-outline-warning table-active" style="width:90%; text-align:center; margin: 0px 0px 900px 60px; font-size: 15px; border-radius:10px; background-color:rgba(229, 140, 132, 0.697)">
            <thead>
                ...
                <th scope="col">Rạp chiếu</th>
                <th scope="col">Loại phim</th>
            ...
            <tbody>
                <tr>
                    ...
                    <td><a href="Thong_Tin_Phim.php" style="color: pink;"><?php echo $row["Ten_Phim"]?></a></td>
                    <td><?php echo $row["Ma_Loai"] ?></td>
                    <td><?php echo $row["Ma_Rap"] ?></td>
                    <td><a href="Functions/Function_Edit_Phim.php?Ma_Phim=<?php echo $row["Ma_Phim"];?>" style="margin-left:12px"><img src="Icons/edit.png" style="width:15px"></a>|
                     <a href="Functions/Function_Delete_Phim.php?Ma_Phim=<?php echo $row["Ma_Phim"];?>" style="margin-left:15px"><img src="Icons/delete.png" style="width:12px"></a></>
                </tr>
            </tbody>
            <?php 
                }
